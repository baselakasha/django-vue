        ...
        <form action="" method="" @submit.prevent="register">
            <div class="field">
                ...
                <p class="control has-icons-left">
                    <input v-model="form_state.first_name" :class="{'is-danger': form_state.errors.first_name}" id="firstname" class="input" type="text" placeholder="" />
            ...
            <div class="field">
                ...
                <p class="control has-icons-left">
                    <input v-model="form_state.last_name" :class="{'is-danger': form_state.errors.last_name}" id="lastname" class="input" type="text" placeholder="" />
                    <span class="icon is-small is-left">
                        <i class="fas fa-user"></i>
                    </span>
                </p>
            ...
            <div class="field">
                ...
                <p class="control has-icons-left">
                    <input v-model="form_state.username" :class="{'is-danger': form_state.errors.username }" id="username" class="input" type="text" placeholder="" />
                    <span class="icon is-small is-left">
                        <i class="fas fa-user"></i>
                    </span>
                </p>
            ...
            <div class="field">
                ...
                <p class="control has-icons-left">
                    <input v-model="form_state.email" :class="{'is-danger': form_state.errors.email}" type="email" class="input" placeholder="" />
                    <span class="icon is-small is-left">
            ...
            <div class="field">
                ...
                <p class="control has-icons-left">
                    <input v-model="form_state.password" :class="{'is-danger': form_state.errors.password}" id="password" class="input" type="password" placeholder="" />
                    <span class="icon is-small is-left">
